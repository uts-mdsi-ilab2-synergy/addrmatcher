...
for state in states:
    ...
    gnaf_address_combined["FULL_ADDRESS"] = gnaf_address_combined[['LOT_NUMBER_PREFIX','LOT_NUMBER','LOT_NUMBER_SUFFIX',
                                                              ...
                                                              'STREET_TYPE_CODE','LOCALITY_NAME','STATE','POSTCODE']].fillna('').agg(''.join, axis = 1)
    ...
    gnaf_address_combined = gnaf_address_combined\
        .merge(asgs[["LGA_NAME_2016","SSC_NAME_2016",
                     "SA4_NAME_2016","SA3_NAME_2016",
                     "SA2_NAME_2016","SA1_7DIGITCODE_2016",
                     "MB_CODE_2016"]], 
        how="inner", 
        left_on="MB_2016", 
